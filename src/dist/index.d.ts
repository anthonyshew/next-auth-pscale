 ...
 */
import { ClientFlavors, SqlFlavorOptions } from "./utils";
 ...
 **/
export declare function DrizzleAdapter<SqlFlavor extends SqlFlavorOptions>(db: SqlFlavor, schema: ClientFlavors<SqlFlavor>): Adapter;
