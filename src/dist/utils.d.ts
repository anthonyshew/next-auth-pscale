...
export type ClientFlavors<T> = T extends AdapterFlavors ? T extends "mysql" ? MySqlDatabase<any, any> : T extends "pg" ? PgDatabase<any, PgSchema, any> : T extends "sqlite" ? BaseSQLiteDatabase<any, any> : T extends "planetscale" ? PlanetScaleDatabase<any> : never : never;
